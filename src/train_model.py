...
def create_enhanced_features(df):
    ...
    # Clean delay data (remove extreme outliers)
    ...
    df_sorted['turnaround_time'] = df_sorted['turnaround_time'].fillna(24)  # Default 24 hours if no previous flight
...
def train_model():
    ...
    # Hyperparameter grids (simplified for faster training)
    param_grids = {
        'rf': {
    ...
    # Also save the legacy single model for backward compatibility
